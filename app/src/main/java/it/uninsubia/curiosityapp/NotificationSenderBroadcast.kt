...
class NotificationSenderBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        var actionIntent = Intent(context, NotificationAnswerBroadcastReceiver::class.java)
        ...
        val notification = NotificationCompat.Builder(context!!, channelid)
            ...
            .addAction(R.mipmap.ic_launcher, "Non lo sapevo", pIntentKnow)
            .build()
